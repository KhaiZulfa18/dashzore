...
const controlStyles = {
    base: "border rounded-xl bg-white dark:bg-gray-950 border-gray-200 dark:border-gray-700 py-1 px-0.5 hover:cursor-pointer",
    focus: "border-primary-600 ring-1 ring-primary-500",
    nonFocus: "border-gray-300 hover:border-gray-400",
};
const placeholderStyles = "text-gray-700 dark:text-white pl-1 py-0.5";
